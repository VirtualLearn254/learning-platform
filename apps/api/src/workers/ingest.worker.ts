...
- CHECK-BEAT TYPE (note it in the outline): computation/procedures -> fill_in; classification/definitions -> multiple_choice; judgment/soft-skills -> scenario; paired concepts -> match. Vary types across the course and step Bloom level up as lessons progress (recall early, apply/analyze later).
